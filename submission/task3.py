...
player = 2
np.random.seed(50)
state_files = {1: './data/attt/states/states_file_p1.txt', 2: './data/attt/states/states_file_p2.txt'}
...
while True :
    ...
    cmd_encoder = "python","encoder.py","--policy", policy_files[3-player].replace(str(3 - player), str(i)),"--states",state_files[player]
    ...
    cmd_decoder = "python","decoder.py","--value-policy","verify_attt_planner","--states",state_files[player] ,"--player-id",str(player)
